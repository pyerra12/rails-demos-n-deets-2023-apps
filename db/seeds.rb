...
Todo.create!(
  title:       'Prepare Q1 2024 Presentation',
  description: 'Presentation on quarterly profits for 2024',
  due_date:    Date.new(2024, 4, 18)
)
...
Todo.create!(
  ...
  due_date:    Date.new(2024, 11, 2)
)

Todo.create!(
  title:       'Take the Dog to the Vet',
  description: 'Newton has a checkup at the vet',
  due_date:    Date.new(2024, 11, 5)
)
